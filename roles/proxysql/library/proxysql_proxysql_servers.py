...
# LooseVersion('2.9.9') > LooseVersion('2.9.27')
...
def main():
    ...
    cursor = None
    # 2.9.27
    # fix tuple no 'execute' attribute
    try:
        #if version.parse(ansible_version) > version.parse('2.9.27'):
...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename='/var/log/ansible.log', level=logging.DEBUG, format=LOG_FORMAT, datefmt=DATE_FORMAT)
